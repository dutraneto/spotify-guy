...
[![Build Status](https://travis-ci.org/dutraneto/spotify-guy.svg?branch=master)](https://travis-ci.org/dutraneto/spotify-guy) [![Coverage Status](https://coveralls.io/repos/github/dutraneto/spotify-guy/badge.svg?branch=master)](https://coveralls.io/github/dutraneto/spotify-guy)

A web app to work with the [Spotify Web API](https://developer.spotify.com/web-api/).
